...
if(isset($_POST['submit'])){
   ...
   $update_profile = $conn->prepare("UPDATE `user` SET name = ? WHERE email = ?");
...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="email" name="email" placeholder="enter your email" class="box" oninput="this.value = this.value.replace(/\s/g, '')" value="<?= $fetch_profile["email"]; ?>" disabled  >
